...
prog : progbody EOF ; //progbody con EOF finale

progbody : LET ( cldec+ dec* | dec+ ) IN exp SEMIC #letInProg //classe
         | exp SEMIC                               #noDecProg
         ;
...
cldec  : CLASS ID (EXTENDS ID)?
              ...
              CLPAR
                   methdec* //non si possono definire variabili nella classe
              CRPAR ;
